<head>
    ...
    .footer {
        position: absolute;
        left: 0;
        bottom: 50px; /* Height of the bottom navigation menu */
        width: 100%;
        height: 60px;
...
/*  Border colours */
    .border-red {
            border: 1px #ee6962 solid;
            color: #ee6962;
        }
        
    .border-yellow {
            border: 1px #fcca48 solid;        
            color: #fcca48;
        }
        
    .border-green {
            border: 1px #8ececa solid;        
            color: #8ececa;
        }
        
    .border-purp {
            border: 1px #9282f0 solid;        
            color: #9282f0;
        }
...
.bg-gray {
    ...
    .listview>li footer {
        ...
        .trans-green-card {
            background: rgba(108, 243 , 127, 20%) !important;
        }
...
<body onload="initMap()" class="text-dark"  style="background: #ffffff" >
    ...
    <div class="appHeader bg-white no-border">
        ...
        <div class="right">
            <a data-toggle="modal" class="me-1 mb-1" data-target="#sidebarPanel" style=" background: transparent !important;">
    ...
    <div id="appCapsule">
        <div class="section mt-2">
            <figure>
                <img src="programs/duration.png" alt="image" class="imaged img-fluid">
            </figure>
            <br>
